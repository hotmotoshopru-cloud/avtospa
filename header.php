...
<header class="site-header">
  <div class="container header-inner">
    <a class="brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="АвтоСпа — главная">Авто<span>Спа</span></a>
    ...
    <div class="header-actions">
      <a class="social-link whatsapp-link" href="<?php echo esc_url(avtospa_whatsapp_url()); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть WhatsApp">WhatsApp</a>
      <a class="social-link telegram-link" href="<?php echo esc_url(avtospa_telegram_url()); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть Telegram">Telegram</a>
