...
<header class="site-header">
  <div class="container header-inner">
    <a class="brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="АвтоСпа — главная">
      <span class="brand-mark" aria-hidden="true"><span>✦</span></span><span>АвтоСпа</span>
    </a>
    <div class="header-location" aria-label="Адрес">
    ...
    <div class="header-actions">
      ...
      <?php if($wa): ?><a class="social-link whatsapp-link" href="<?php echo esc_url($wa); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть WhatsApp"><span aria-hidden="true">◉</span><b>WhatsApp</b></a><?php endif; ?>
      <?php if($tg): ?><a class="social-link telegram-link" href="<?php echo esc_url($tg); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть Telegram"><span aria-hidden="true">➤</span><b>Telegram</b></a><?php endif; ?>
      ...
      <button class="mobile-toggle" type="button" aria-expanded="false" aria-controls="mobile-menu" aria-label="Открыть меню"><span class="menu-bars" aria-hidden="true"><i></i><i></i><i></i></span></button>
    </div>
  </div>
