...
<header class="site-header">
  <div class="container header-inner">
    <a class="brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="АвтоСпа — главная"><span class="brand-mark" aria-hidden="true">✦</span><span>АвтоСпа</span></a>
    <div class="header-location"><span class="location-dot" aria-hidden="true">●</span><span>Москва<br><small>Полярный проезд, 18</small></span></div>
    ...
    <div class="header-actions">
      ...
      <?php if($wa): ?><a class="social-link whatsapp-link" href="<?php echo esc_url($wa); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть WhatsApp">WA</a><?php endif; ?>
      <?php if($tg): ?><a class="social-link telegram-link" href="<?php echo esc_url($tg); ?>" target="_blank" rel="noopener noreferrer" aria-label="Открыть Telegram">TG</a><?php endif; ?>
